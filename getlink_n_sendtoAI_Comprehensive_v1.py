...
def run_bot():
    ...
    with open(csv_filename, mode='r', encoding='utf-8-sig') as file:
        ...
        for row in reader:
            ...
            # --- RUN 3 MISSIONS PER REGION ---
            for mission in MISSIONS:
                prompt = f"""
                Analyze these links from USR {region} for the topic: {mission['topic']}.
                
                Rules:
                - If a relevant link is found, IT DOES NOT HAVE TO BE EXACT JUST SIMILAR ENOUGH, respond ONLY: MATCH: [Title] | [Full URL]
