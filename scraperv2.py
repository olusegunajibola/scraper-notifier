...
# New SDK automatically looks for GEMINI_API_KEY env var
client = genai.Client()
...
def ask_gemini(page_text, region_name):
    ...
    Rules:
    - If a specific call in March 2026 or later exists for use of calculators is found: respond "MATCH: [Summary]".
